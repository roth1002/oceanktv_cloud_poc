$(document).ready(function() {
    ...
    $(".landing_item").find("li").each(function(index, el) {
        if (index == 4) {
            $(this).html("<a href=" + linkarr[index] + " target=" + "_blank" + "><img src=" + "images/" + imgarr[index] + "_normal.png" + " data-alt-src=" + "images/" + imgarr[index] + "_hover.png><p>" + wordarr[index] + "</p></a>");
        } else {
            $(this).html("<a href=" + linkarr[index] + "><img src=" + "images/" + imgarr[index] + "_normal.png" + " data-alt-src=" + "images/" + imgarr[index] + "_hover.png><p>" + wordarr[index] + "</p></a>");
        }
...
function tFunction() { //quick tutorial
        ...
        var t1 = '<div class="popup"><a href="#" class="btn_close"><i class="delete"></i></a><div class="tutorial"><img src="images/img_quicktutorial_p1_en.png" /><p>感謝您選擇 QNAP NAS 並使用 Ocean KTV。<br>有了 Ocean KTV，您的 NAS 就能搖身一變成為一台人人都愛的伴唱機！<br>以下導覽將協助您了解 Ocean KTV 的使用方法。</p><div class="btn_start">開始導覽</div></div></div>'
        var t2 = '<div class="popup"><a href="#" class="btn_close"><i class="delete"></i></a><h4>快拿出你的平板電腦或手機，使用行動裝置點歌</h4><hr><div class="t_content"><p>除了透過電視或電腦的 Ocean KTV 點歌之外，您也可以透過行動裝置點歌。馬上掃描QRcode下載 Ocean KTV 應用程式！</p><img src="images/img_quicktutorial_p2_en.png" /></div><button class="btn_next">下一步</button><button class="btn_pre">上一步</button>' + progress + '</div>'
        var t3 = '<div class="popup"><a href="#" class="btn_close"><i class="delete"></i></a><h4>將您收藏的歌曲匯入 Ocean KTV</h4><hr><div class="t_content"><ul><li>KTV歌曲與電影皆屬於影片檔案，由於無法分辨出何者為KTV檔案，您必須手動將您蒐藏的歌曲匯入專屬的資料夾。</li><li>1. 請將您的歌曲存放在OceanKTV資料夾或是其他您自行建立的資料。</li><li>2. 前往設定內的〔資料夾來源〕將該資料夾設定為OceanKTV使用，則該資料夾內的影片會被視為KTV檔案。</li></ul><p class="tip">請注意：建議使用電腦開啟QTS進行匯入步驟。</p><img src="images/img_quicktutorial_p2.png" /></div><button class="btn_next">下一步</button><button class="btn_pre">上一步</button>' + progress + '</div>'
        var t4 = '<div class="popup"><a href="#" class="btn_close"><i class="delete"></i></a><h4>編輯歌曲名稱</h4><hr><div class="t_content"><p>您可以透過OceanKTV Console的歌曲編輯功能修改檔名，以在OceanKTV中藉由歌曲資料找到歌曲。</p><img src="images/img_quicktutorial_p3.png" /></div><button>開始歡唱</button><button>上一步</button>' + progress + '</div>'
        var t = 0;
